...
1. Fork the `https://github.com/py-package/masonite-security` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/security.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall security && pip install .`
